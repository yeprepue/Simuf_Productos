...
<html>
    <head>
        ...
        <title>Modificar categoria| Mundo Friky</title>
    ...
    <body>
        ...
        %>
        <%=  cc.getEditViewCategoria(IdCategoria)%>
        ...
        <script src="js/administracionCategorias.js" type="text/javascript"></script>
        <script src="js/paneladministracion.js" type="text/javascript"></script>
    </body>
</html>
