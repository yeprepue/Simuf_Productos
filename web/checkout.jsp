...
<head>
    ...
    <title>Checkout|Mundo Friky</title>
				...
				<div class="row">
					<div class="col-md-4 clearfix">
						<div class="logo pull-left">
							<a href="index.html"><img src="images/home/LogoSimuf.png" style="" width="100" height="60" alt="" /></a>
						</div>
					</div>
					<div class="col-md-8 clearfix">
						<div class="shop-menu clearfix pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="checkout.html"><i class="fa fa-crosshairs"></i> Lista de deseos</a></li>
								<li><a href="cart.html"><i class="fa fa-shopping-cart"></i> Carrito de compras</a></li>
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										<li><a href="checkout.html" class="active">Mis compras</a></li> 
				...
				<div class="row">
					...
					<div class="col-sm-4">
						<div class="order-message">
							<p>Notas de tu pedido.</p>
							<textarea name="message"  placeholder="Agrega opservaciones antes de finalizar tu orden, dejamos observaciones de como llegar" rows="16"></textarea>
							<label><input type="checkbox"> Enviar a direccion de facturación </label>
						</div>	
					</div>					
				</div>
			</div>			
